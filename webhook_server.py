    ...
    try:
        ...
        for change in entry.get("changes", []):
            if change.get("field") == "comments":
                ...
                if product and "comments" in product and comment_text:
                    # comment_text ni kichik qilib solishtiramiz
                    for trigger in product["comments"]:
                        if comment_text.lower() == trigger.lower():
